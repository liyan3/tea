(function(e,t){
	if(!e)return t;
	//console.log(t);//false
	//console.log(e); //引用JQuery
    var n=function(){
		this.el=t;
		this.items=t;
		  //console.log(this);
		this.sizes=[];
		this.max=[0,0];this.current=0;
		this.interval=t;
		...
		this.setup=function(){
			...
			if(this.opts.fluid){
				var r=function(){
					n.el.css("width",Math.min(Math.round(n.el.outerWidth()/n.el
						.parent().outerWidth()*100),100)+"%")};
					r();
				e(window).resize(r)}
			if(this.opts.arrows){
		...
		this.move=function(t,r){
			...
			if(!this.ul.is(":animated")){
				n.el.find(".dot:eq("+t+")").addClass("active")
					.siblings().removeClass("active");
				this.el.animate(s,o)&&this.ul.animate(e.extend({left:"-"+t+"00%"},s),
					o,
					function(i){n.current=t;
		...
		this.stop=function(){
			n.interval=clearInterval(n.interval);return n
		};
		...
		this.dots=function(){var t='<ol class="dots">';
			e.each(this.items,function(e){
				...
				t+="</ol>";
			this.el.addClass("has-dots").append(t).find(".dot")
				.click(function(){n.move(e(this).index())})
			}
	};
